...
```bash
$ yarn add aomao_plugin-fontfamily
```
...
import Fontfamily from 'aomao_plugin-fontfamily';
...
```ts
import { fontFamilyDefaultData, fontfamily } from 'aomao_toolbar'; // 或 aomao_toolbar-vue
```
